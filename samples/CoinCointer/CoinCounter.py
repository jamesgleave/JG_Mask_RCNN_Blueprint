...
CoinCounter_MODEL_PATH = os.path.join(ROOT_DIR, "logs/mask_rcnn_coco.h5")
# Download COCO trained weights from Releases if needed
if not os.path.exists(CoinCounter_MODEL_PATH):
    utils.download_trained_weights(CoinCounter_MODEL_PATH)
...
model.load_weights(CoinCounter_MODEL_PATH, by_name=True)
