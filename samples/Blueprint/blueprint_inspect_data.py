...
from samples.Blueprint import blueprint


# Configuration:
config = blueprint.BlueprintConfig
BLUEPRINT_DIR = os.path.join(ROOT_DIR, "datasets/blueprint")
...
# Load dataset
dataset = blueprint.BlueprintDataset()
dataset.load_blueprint(BLUEPRINT_DIR, "val")
